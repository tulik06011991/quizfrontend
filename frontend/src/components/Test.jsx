...
const Quiz = () => {
  ...
  useEffect(() => {
    const fetchQuiz = async () => {
      try {
        const response = await axios.get('https://quizbackend-4-sfck.onrender.com/test/quiz');
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post('https://quizbackend-4-sfck.onrender.com/test/submit', {
