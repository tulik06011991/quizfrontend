...
const AdminPanel = () => {
  ...
  useEffect(() => {
    if (activeTab === 'users') {
      axiosInstance
        .get('https://quizbackend-ntmd.onrender.com/api/results')
    ...
    if (activeTab === 'questions') {
      axiosInstance
        .get('https://quizbackend-ntmd.onrender.com/savollar/question')
        .then((response) => {
    ...
    if (activeTab === 'subjects') {
      axiosInstance
        .get('https://quizbackend-ntmd.onrender.com/api/fanlar')
  ...
  const deleteQuestions = () => {
    axiosInstance
      .delete('https://quizbackend-ntmd.onrender.com/deleteAll/delete')
      .then((response) => {
  ...
  const deleteUser = (Id) => {
    axiosInstance
      .delete(`https://quizbackend-ntmd.onrender.com/api/result/${Id}`)
      .then((response) => {
  ...
  const handleSubmit = () => {
    ...
    axiosInstance
      .post('https://quizbackend-ntmd.onrender.com/api/question', newQuestionData)
      .then((response) => {
  ...
  const handleUpdateQuestion = () => {
    ...
    axiosInstance
      .put(`https://quizbackend-ntmd.onrender.com/api/question/${currentQuestion._id}`, updatedQuestionData)
      .then((response) => {
